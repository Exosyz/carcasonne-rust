...
- [ ] Ajouter un genre de SxProps Pour permettre d'ajouter "simplement" des contraintes sur des elements
    - [ ] *Avec une Enum se serait peut être plus simple et facielement applicable dans l'idée des NodeTag qui sont
      aujourd'hui plus des SXProps de Text/Char
- [x]  Split l'enum de node en un trait nore renderable
    - [x] Ajouter un NodeWrapper pour permettre d'ajouter le trait a chaque element pour bien split les comportement
...
- [x] Comment faire en sorte de pouvoir utiliser tous l'espace disponible ?
    ...
    - [x] Ajouter un genre de SxProps Pour permettre d'ajouter "simplement" des contraintes sur des elements
        - [x] Avec une Enum se serait peut être plus simple et facielement applicable dans l'idée des NodeTag qui sont
          aujourd'hui plus des SXProps de Text/Char
        - [ ] 
...
- [x] séparer les containers des Node ?
    ...
    - [x] Surement une très bonne chose a faire pour la suite, permettrais de beaucoup simplifier les choses et de scale
...
- [ ] Le nouveau système serait
    ...
    - [x] est-ce qu'il y a encore besoin du systéme de size, si par default le body (le composant initial est fullsize)
      et que tous est build relativement
