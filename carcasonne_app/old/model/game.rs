...
use crate::renderer::base_renderer::GameRendererType;
...
impl Game {
    ...
    pub fn render(&mut self) {
        ...
        match renderer {
            GameRendererType::Ascii(renderer) => renderer.render(self),
            GameRendererType::Unicode(renderer) => renderer.render(self),
            GameRendererType::Graphic(renderer) => renderer.render(self),
        }
    }
}
